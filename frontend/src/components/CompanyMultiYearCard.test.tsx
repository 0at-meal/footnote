...
describe('CompanyMultiYearCard Component', () => {
  it('does not render if fewer than 2 completed jobs exist for the company', () => {
  ...
  it('renders Multi-Year card with Build button and included fiscal years when >= 2 jobs are completed', () => {
    const company: CompanyWithJobs = {
    ...
    expect(html).toContain('Multi-Year Model: Acme Holdings (ACME)')
